./nachos-final -f 
./nachos-final -cp ListDirectory ls
./nachos-final -cp MakeDir mkdir
./nachos-final -cp ChangeDir cd
./nachos-final -cp DeleteDirectory rm
./nachos-final -cp GetIntCommand GetInt
...
./nachos-final -cp fork1 fork1-test
./nachos-final -cp fork2 fork2-test
./nachos-final -cp conopen conopen-test
