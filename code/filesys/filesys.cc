...
{ 
    ...
    Create(".", DirectoryFileSize, FileHeader::DOTLINK);
    Create("..", DirectoryFileSize, FileHeader::DOTLINK);
...
bool FileSystem::CreateDirectory(const char *name) {
    ...
    // Get the sector number of the header of the parent folder
    FileHeader* fileheader = new FileHeader;
    ...
    Create(".", DirectoryFileSize, FileHeader::DOTLINK);    // Create a "." directory
